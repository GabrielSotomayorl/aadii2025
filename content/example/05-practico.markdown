...
*   **Ingreso por Región:** La salida `head(ingreso_x_region)` muestra el ingreso medio estimado y su error estándar (SE) para las primeras regiones. Vemos diferencias: Antofagasta tiene un ingreso medio estimado más alto (\$1,819,321, SE \$46,307) que, por ejemplo, Coquimbo (\$1,438,892, SE \$39,039). Errores estándar más pequeños indican mayor precisión en la estimación para esa región específica. (Para una comparación completa, deberías mirar la tabla completa `ingreso_x_region`).
