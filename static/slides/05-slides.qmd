...
*   `vartype = c("se", "ci", "var", "cv")`: Para pedir el tipo de medida de variabilidad (error estándar, intervalo confianza, varianza, coef. variación). Por defecto es "se".
*   `level = 0.95`: Para cambiar el nivel de confianza del IC.
...
5.  (Opcional) Ejecutaremos una **regresión lineal** simple con `svyglm`.
