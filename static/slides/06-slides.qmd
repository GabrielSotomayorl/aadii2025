...
En esta (potencialmente larga) sesión, construiremos las bases para el análisis multivariado:
...
*   **Análisis Factorial Exploratorio (AFE):**
    ...
    *   **Naturaleza:** Guiado por los datos, busca descubrir estructura.
...
*   **Análisis Factorial Confirmatorio (AFC), Análisis de Senderos, Modelos de Ecuaciones Estructurales (SEM):**
    ...
    *   **Naturaleza:** Guiado por la teoría, busca validar un modelo específico.
...
*   **Modelos Relacionales / Estructurales:**
    ...
    *   **Análisis de Senderos:** Modela relaciones causales hipotetizadas entre variables *observadas*.
...
Recordatorio rápido: Para entender relaciones, primero necesitamos entender cómo varían las variables por sí solas.
