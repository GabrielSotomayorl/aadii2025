...
![](img/placeholder_latente_observada.png){fig-align="center" width="65%"}
*Placeholder: Diagrama conceptual mostrando una variable latente (círculo) con flechas hacia varias variables observadas (cuadrados).*

## ¿Qué es el Análisis Factorial Exploratorio (AFE)? {.smaller .dark-background}
...
## El Modelo Matemático del AFE {.smaller background-color="white"}
...
*   **Evaluación Inicial:**
    ...
    *   **Test de Esfericidad de Bartlett:**
        *   $H_0$: La matriz de correlaciones es una matriz identidad (variables no correlacionadas).
        *   $H_1$: La matriz de correlaciones NO es una matriz identidad.
        *   **Resultado deseado:** Rechazar $H_0$ (p-valor < 0.05). Indica que hay suficiente correlación para proceder.
...
*   **¿Qué hacer?**
    *   **Evaluar normalidad univariada:** Revisar asimetría y curtosis de cada variable. Valores de asimetría entre $\pm 2$ (o $\pm 1$) suelen considerarse aceptables.
...
*   **Casos Atípicos (Outliers):**
    ...
    *   **Multivariados:** Combinaciones inusuales de valores en múltiples variables. Se detectan con la **Distancia de Mahalanobis ($D^2$)**. Valores de $D^2$ con p-valor < 0.001 suelen considerarse atípicos multivariantes.
